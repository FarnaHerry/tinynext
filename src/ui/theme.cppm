...
export const AppTheme kDarkTheme = {
    ...
    {0.86f, 0.86f, 0.86f, 1.0f},   // 文件名 浅灰
    {0.58f, 0.58f, 0.60f, 1.0f},   // 次要文本 灰
    {0.42f, 0.42f, 0.44f, 1.0f},   // 空态提示 灰
    {0.82f, 0.82f, 0.84f, 1.0f},   // 状态消息 浅灰
    {0.86f, 0.88f, 0.90f, 1.0f},   // 下载中 近白（活动态）
    {0.72f, 0.72f, 0.70f, 1.0f},   // 暂停 灰
    {0.55f, 0.82f, 0.60f, 1.0f},   // 完成 柔和绿（状态功能区分）
    {0.92f, 0.48f, 0.44f, 1.0f},   // 失败 柔和红
...
export const AppTheme kLightTheme = {
    false,
    {0.12f, 0.12f, 0.12f, 1.0f},   // 标题 近黑
    {0.18f, 0.18f, 0.18f, 1.0f},   // 文件名 深灰
    {0.45f, 0.45f, 0.47f, 1.0f},   // 次要文本 灰
    {0.55f, 0.55f, 0.57f, 1.0f},   // 空态提示 灰
    {0.15f, 0.15f, 0.16f, 1.0f},   // 状态消息 近黑
    {0.15f, 0.16f, 0.18f, 1.0f},   // 下载中 近黑（活动态）
    {0.55f, 0.55f, 0.52f, 1.0f},   // 暂停 灰
    {0.10f, 0.55f, 0.30f, 1.0f},   // 完成 绿
    {0.80f, 0.25f, 0.20f, 1.0f},   // 失败 红
    {0.50f, 0.50f, 0.52f, 1.0f},   // 空闲 灰
    [] {
